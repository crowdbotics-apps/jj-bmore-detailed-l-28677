"""jj_bmore_detailed_l_28677 URL Configuration
...
admin.site.site_header = "JJ Bmore Detailed LLC"
admin.site.site_title = "JJ Bmore Detailed LLC Admin Portal"
admin.site.index_title = "JJ Bmore Detailed LLC Admin"

# swagger
api_info = openapi.Info(
    title="JJ Bmore Detailed LLC API",
    default_version="v1",
    description="API documentation for JJ Bmore Detailed LLC App",
)
